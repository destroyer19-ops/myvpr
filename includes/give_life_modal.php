    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="giveLifeModalLabel">Give Your Life to Christ</h5>
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <a href="log_salvation_decision.php" class="btn btn-primary btn-lg mt-3" id="logDecisionButton">
